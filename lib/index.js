...
extend(Adapter.prototype, {
  ...
  run: function(operationName, options, onRun) {
    var method = this[operationName];
    if (!method) return onRun();
    if (!options.collection) return onRun(new Error("collection must exist"));
    method.call(this, this._collection(options.collection), options, onRun);
  },
...
module.exports = function(options) {
  ...
  var ret = function(operationName, options) {
    ...
    process.nextTick(function() {
      db.run(operationName, options, function(err, data) {
